...
public class Projekt extends Render {
    ...
    public void paint(Graphics g) {
        ...
        /** @TODO Springanimationen buggar
         * 
         */
        
        BufferedImage t = focus.c.getSubimage(radius * (((int) (focus.incr > 1.0 && focus.frame != 0 ? focus.frame + 4 : focus.frame)) % 8), 20 * focus.direciton, radius, 20);
